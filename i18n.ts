...
const mergedFa = { ...navbarFa, ...businessPermitFa, ...businessVisitFa, ...globalVisitVisasFa, ...workPermitFa, ...eorPayrollFa, ...studyInEuFa, ...asylumFa, ...companyRegistrationFa, ...euCitizensRelocationFa, ...euCitizensParentsPermitFa, ...familyReunificationFa, ...logisticsServicesFa, ...selfEmployedFa, ...auPairHostFamilyFa, ...buySellPropertyFa, ...appealCasesFa, ...bookkeepingSolutionsFa, ...cbiBbiFa, ...destinationServicesFa, ...financialManagementFa, ...housingFa, ...lawyersFa, ...manpowerSolutionsFa };
...
const mergedIt = { ...navbarIt, ...businessPermitIt, ...businessVisitIt, ...globalVisitVisasIt, ...workPermitIt, ...eorPayrollIt, ...studyInEuIt, ...asylumIt, ...companyRegistrationIt, ...euCitizensRelocationIt, ...euCitizensParentsPermitIt, ...familyReunificationIt, ...logisticsServicesIt, ...selfEmployedIt, ...auPairHostFamilyIt, ...buySellPropertyIt, ...appealCasesIt, ...bookkeepingSolutionsIt, ...cbiBbiIt, ...destinationServicesIt, ...financialManagementIt, ...housingIt, ...lawyersIt, ...manpowerSolutionsIt };
...
const mergedUr = { ...navbarUr, ...businessPermitUr, ...businessVisitUr, ...globalVisitVisasUr, ...workPermitUr, ...eorPayrollUr, ...studyInEuUr, ...asylumUr, ...companyRegistrationUr, ...euCitizensRelocationUr, ...euCitizensParentsPermitUr, ...familyReunificationUr, ...logisticsServicesUr, ...selfEmployedUr, ...auPairHostFamilyUr, ...buySellPropertyUr, ...appealCasesUr, ...bookkeepingSolutionsUr, ...cbiBbiUr, ...destinationServicesUr, ...financialManagementUr, ...housingUr, ...lawyersUr, ...manpowerSolutionsUr };
