...
// Import FAQs translations
import faqsEn from './messages/faqs/en.json';
import faqsSv from './messages/faqs/sv.json';
import faqsAr from './messages/faqs/ar.json';
import faqsDa from './messages/faqs/da.json';
import faqsDe from './messages/faqs/de.json';
import faqsEl from './messages/faqs/el.json';
import faqsEs from './messages/faqs/es.json';
import faqsFa from './messages/faqs/fa.json';
import faqsFi from './messages/faqs/fi.json';
import faqsFr from './messages/faqs/fr.json';
import faqsIt from './messages/faqs/it.json';
import faqsNb from './messages/faqs/nb.json';
import faqsNl from './messages/faqs/nl.json';
import faqsPa from './messages/faqs/pa.json';
import faqsPs from './messages/faqs/ps.json';
import faqsTa from './messages/faqs/ta.json';
import faqsTe from './messages/faqs/te.json';
import faqsUr from './messages/faqs/ur.json';

// Import career translations
...
import businessSalePurchaseEn from './messages/business-sale-purchase/en.json';
...
// Import pet-relocation translations for all languages
import petRelocationEn from './messages/pet-relocation/en.json';
import petRelocationAr from './messages/pet-relocation/ar.json';
import petRelocationDa from './messages/pet-relocation/da.json';
import petRelocationDe from './messages/pet-relocation/de.json';
import petRelocationEl from './messages/pet-relocation/el.json';
import petRelocationEs from './messages/pet-relocation/es.json';
import petRelocationFa from './messages/pet-relocation/fa.json';
import petRelocationFi from './messages/pet-relocation/fi.json';
import petRelocationFr from './messages/pet-relocation/fr.json';
import petRelocationIt from './messages/pet-relocation/it.json';
import petRelocationNb from './messages/pet-relocation/nb.json';
import petRelocationNl from './messages/pet-relocation/nl.json';
import petRelocationPa from './messages/pet-relocation/pa.json';
import petRelocationPs from './messages/pet-relocation/ps.json';
import petRelocationSv from './messages/pet-relocation/sv.json';
import petRelocationTa from './messages/pet-relocation/ta.json';
import petRelocationTe from './messages/pet-relocation/te.json';
import petRelocationUr from './messages/pet-relocation/ur.json';
...
// Import business-sale-purchase translations for all languages
import businessSalePurchaseAr from './messages/business-sale-purchase/ar.json';
import businessSalePurchaseDa from './messages/business-sale-purchase/da.json';
import businessSalePurchaseDe from './messages/business-sale-purchase/de.json';
import businessSalePurchaseEl from './messages/business-sale-purchase/el.json';
import businessSalePurchaseEs from './messages/business-sale-purchase/es.json';
import businessSalePurchaseFa from './messages/business-sale-purchase/fa.json';
import businessSalePurchaseFi from './messages/business-sale-purchase/fi.json';
import businessSalePurchaseFr from './messages/business-sale-purchase/fr.json';
import businessSalePurchaseIt from './messages/business-sale-purchase/it.json';
import businessSalePurchaseNb from './messages/business-sale-purchase/nb.json';
import businessSalePurchaseNl from './messages/business-sale-purchase/nl.json';
import businessSalePurchasePa from './messages/business-sale-purchase/pa.json';
import businessSalePurchasePs from './messages/business-sale-purchase/ps.json';
import businessSalePurchaseSv from './messages/business-sale-purchase/sv.json';
import businessSalePurchaseTa from './messages/business-sale-purchase/ta.json';
import businessSalePurchaseTe from './messages/business-sale-purchase/te.json';
import businessSalePurchaseUr from './messages/business-sale-purchase/ur.json';
...
// Import lawyers translations for all languages
import lawyersAr from './messages/lawyers/ar.json';
import lawyersDa from './messages/lawyers/da.json';
import lawyersDe from './messages/lawyers/de.json';
import lawyersEl from './messages/lawyers/el.json';
import lawyersEs from './messages/lawyers/es.json';
import lawyersFa from './messages/lawyers/fa.json';
import lawyersFi from './messages/lawyers/fi.json';
import lawyersFr from './messages/lawyers/fr.json';
import lawyersIt from './messages/lawyers/it.json';
import lawyersNb from './messages/lawyers/nb.json';
import lawyersNl from './messages/lawyers/nl.json';
import lawyersPa from './messages/lawyers/pa.json';
import lawyersPs from './messages/lawyers/ps.json';
import lawyersSv from './messages/lawyers/sv.json';
import lawyersTa from './messages/lawyers/ta.json';
import lawyersTe from './messages/lawyers/te.json';
import lawyersUr from './messages/lawyers/ur.json';

// Import manpower-solutions translations for all languages
import manpowerSolutionsAr from './messages/manpower-solutions/ar.json';
import manpowerSolutionsDa from './messages/manpower-solutions/da.json';
import manpowerSolutionsDe from './messages/manpower-solutions/de.json';
import manpowerSolutionsEl from './messages/manpower-solutions/el.json';
import manpowerSolutionsEs from './messages/manpower-solutions/es.json';
import manpowerSolutionsFa from './messages/manpower-solutions/fa.json';
import manpowerSolutionsFi from './messages/manpower-solutions/fi.json';
import manpowerSolutionsFr from './messages/manpower-solutions/fr.json';
import manpowerSolutionsIt from './messages/manpower-solutions/it.json';
import manpowerSolutionsNb from './messages/manpower-solutions/nb.json';
import manpowerSolutionsNl from './messages/manpower-solutions/nl.json';
import manpowerSolutionsPa from './messages/manpower-solutions/pa.json';
import manpowerSolutionsPs from './messages/manpower-solutions/ps.json';
import manpowerSolutionsSv from './messages/manpower-solutions/sv.json';
import manpowerSolutionsTa from './messages/manpower-solutions/ta.json';
import manpowerSolutionsTe from './messages/manpower-solutions/te.json';
import manpowerSolutionsUr from './messages/manpower-solutions/ur.json';
...
// Import partners translations for all languages
import partnersEn from './messages/partners/en.json';
import partnersAr from './messages/partners/ar.json';
import partnersDa from './messages/partners/da.json';
import partnersDe from './messages/partners/de.json';
import partnersEl from './messages/partners/el.json';
import partnersEs from './messages/partners/es.json';
import partnersFa from './messages/partners/fa.json';
import partnersFi from './messages/partners/fi.json';
import partnersFr from './messages/partners/fr.json';
import partnersIt from './messages/partners/it.json';
import partnersNb from './messages/partners/nb.json';
import partnersNl from './messages/partners/nl.json';
import partnersPa from './messages/partners/pa.json';
import partnersPs from './messages/partners/ps.json';
import partnersSv from './messages/partners/sv.json';
import partnersTa from './messages/partners/ta.json';
import partnersTe from './messages/partners/te.json';
import partnersUr from './messages/partners/ur.json';
...
const mergedAr = { ...faqsAr, ...navbarAr, ...businessPermitAr, ...businessVisitAr, ...globalVisitVisasAr, ...workPermitAr, ...eorPayrollAr, ...studyInEuAr, ...asylumAr, ...companyRegistrationAr, ...euCitizensRelocationAr, ...euCitizensParentsPermitAr, ...familyReunificationAr, ...logisticsServicesAr, ...selfEmployedAr, ...auPairHostFamilyAr, ...buySellPropertyAr, ...businessSalePurchaseAr, ...appealCasesAr, ...bookkeepingSolutionsAr, ...cbiBbiAr, ...destinationServicesAr, ...financialManagementAr, ...housingAr, ...lawyersAr, ...manpowerSolutionsAr, ...petRelocationAr, ...partnersAr };
const mergedDa = { ...faqsDa, ...navbarDa, ...businessPermitDa, ...businessVisitDa, ...globalVisitVisasDa, ...workPermitDa, ...citizenshipDa, ...eorPayrollDa, ...studyInEuDa, ...asylumDa, ...companyRegistrationDa, ...euCitizensRelocationDa, ...euCitizensParentsPermitDa, ...familyReunificationDa, ...logisticsServicesDa, ...selfEmployedDa, ...auPairHostFamilyDa, ...buySellPropertyDa, ...businessSalePurchaseDa, ...appealCasesDa, ...bookkeepingSolutionsDa, ...cbiBbiDa, ...destinationServicesDa, ...financialManagementDa, ...housingDa, ...lawyersDa, ...manpowerSolutionsDa, ...petRelocationDa, ...partnersDa };
const mergedDe = { ...faqsDe, ...navbarDe, ...businessPermitDe, ...businessVisitDe, ...globalVisitVisasDe, ...workPermitDe, ...eorPayrollDe, ...studyInEuDe, ...asylumDe, ...companyRegistrationDe, ...euCitizensRelocationDe, ...euCitizensParentsPermitDe, ...familyReunificationDe, ...logisticsServicesDe, ...selfEmployedDe, ...auPairHostFamilyDe, ...buySellPropertyDe, ...businessSalePurchaseDe, ...appealCasesDe, ...bookkeepingSolutionsDe, ...cbiBbiDe, ...destinationServicesDe, ...financialManagementDe, ...housingDe, ...lawyersDe, ...manpowerSolutionsDe, ...petRelocationDe, ...partnersDe };
const mergedEl = { ...faqsEl, ...navbarEl, ...businessPermitEl, ...businessVisitEl, ...globalVisitVisasEl, ...workPermitEl, ...eorPayrollEl, ...studyInEuEl, ...asylumEl, ...companyRegistrationEl, ...euCitizensRelocationEl, ...euCitizensParentsPermitEl, ...familyReunificationEl, ...logisticsServicesEl, ...selfEmployedEl, ...auPairHostFamilyEl, ...buySellPropertyEl, ...businessSalePurchaseEl, ...appealCasesEl, ...bookkeepingSolutionsEl, ...cbiBbiEl, ...destinationServicesEl, ...financialManagementEl, ...housingEl, ...lawyersEl, ...manpowerSolutionsEl, ...petRelocationEl, ...partnersEl };
const mergedEs = { ...faqsEs, ...navbarEs, ...businessPermitEs, ...businessVisitEs, ...globalVisitVisasEs, ...workPermitEs, ...eorPayrollEs, ...studyInEuEs, ...asylumEs, ...companyRegistrationEs, ...euCitizensRelocationEs, ...euCitizensParentsPermitEs, ...familyReunificationEs, ...logisticsServicesEs, ...selfEmployedEs, ...auPairHostFamilyEs, ...buySellPropertyEs, ...businessSalePurchaseEs, ...appealCasesEs, ...bookkeepingSolutionsEs, ...cbiBbiEs, ...destinationServicesEs, ...financialManagementEs, ...housingEs, ...lawyersEs, ...manpowerSolutionsEs, ...petRelocationEs, ...partnersEs };
const mergedFa = { ...faqsFa, ...navbarFa, ...businessPermitFa, ...businessVisitFa, ...globalVisitVisasFa, ...workPermitFa, ...eorPayrollFa, ...studyInEuFa, ...asylumFa, ...companyRegistrationFa, ...euCitizensRelocationFa, ...euCitizensParentsPermitFa, ...familyReunificationFa, ...logisticsServicesFa, ...selfEmployedFa, ...auPairHostFamilyFa, ...buySellPropertyFa, ...businessSalePurchaseFa, ...appealCasesFa, ...bookkeepingSolutionsFa, ...cbiBbiFa, ...destinationServicesFa, ...financialManagementFa, ...housingFa, ...lawyersFa, ...manpowerSolutionsFa, ...petRelocationFa, ...partnersFa };
const mergedFi = { ...faqsFi, ...navbarFi, ...businessPermitFi, ...businessVisitFi, ...globalVisitVisasFi, ...workPermitFi, ...citizenshipFi, ...eorPayrollFi, ...studyInEuFi, ...asylumFi, ...companyRegistrationFi, ...euCitizensRelocationFi, ...euCitizensParentsPermitFi, ...familyReunificationFi, ...logisticsServicesFi, ...selfEmployedFi, ...auPairHostFamilyFi, ...buySellPropertyFi, ...businessSalePurchaseFi, ...appealCasesFi, ...bookkeepingSolutionsFi, ...cbiBbiFi, ...destinationServicesFi, ...financialManagementFi, ...housingFi, ...lawyersFi, ...manpowerSolutionsFi, ...petRelocationFi, ...partnersFi };
const mergedFr = { ...faqsFr, ...navbarFr, ...businessPermitFr, ...businessVisitFr, ...globalVisitVisasFr, ...workPermitFr, ...eorPayrollFr, ...studyInEuFr, ...asylumFr, ...companyRegistrationFr, ...euCitizensRelocationFr, ...euCitizensParentsPermitFr, ...familyReunificationFr, ...logisticsServicesFr, ...selfEmployedFr, ...auPairHostFamilyFr, ...buySellPropertyFr, ...businessSalePurchaseFr, ...appealCasesFr, ...bookkeepingSolutionsFr, ...cbiBbiFr, ...destinationServicesFr, ...financialManagementFr, ...housingFr, ...lawyersFr, ...manpowerSolutionsFr, ...petRelocationFr, ...partnersFr };
const mergedIt = { ...faqsIt, ...navbarIt, ...businessPermitIt, ...businessVisitIt, ...globalVisitVisasIt, ...workPermitIt, ...eorPayrollIt, ...studyInEuIt, ...asylumIt, ...companyRegistrationIt, ...euCitizensRelocationIt, ...euCitizensParentsPermitIt, ...familyReunificationIt, ...logisticsServicesIt, ...selfEmployedIt, ...auPairHostFamilyIt, ...buySellPropertyIt, ...businessSalePurchaseIt, ...appealCasesIt, ...bookkeepingSolutionsIt, ...cbiBbiIt, ...destinationServicesIt, ...financialManagementIt, ...housingIt, ...lawyersIt, ...manpowerSolutionsIt, ...petRelocationIt, ...partnersIt };
const mergedNb = { ...faqsNb, ...navbarNb, ...businessPermitNb, ...businessVisitNb, ...globalVisitVisasNb, ...workPermitNb, ...citizenshipNb, ...eorPayrollNb, ...studyInEuNb, ...asylumNb, ...companyRegistrationNb, ...euCitizensRelocationNb, ...euCitizensParentsPermitNb, ...familyReunificationNb, ...logisticsServicesNb, ...selfEmployedNb, ...auPairHostFamilyNb, ...buySellPropertyNb, ...businessSalePurchaseNb, ...appealCasesNb, ...bookkeepingSolutionsNb, ...cbiBbiNb, ...destinationServicesNb, ...financialManagementNb, ...housingNb, ...lawyersNb, ...manpowerSolutionsNb, ...petRelocationNb, ...partnersNb };
const mergedNl = { ...faqsNl, ...navbarNl, ...businessPermitNl, ...businessVisitNl, ...globalVisitVisasNl, ...workPermitNl, ...eorPayrollNl, ...studyInEuNl, ...asylumNl, ...companyRegistrationNl, ...euCitizensRelocationNl, ...euCitizensParentsPermitNl, ...familyReunificationNl, ...logisticsServicesNl, ...selfEmployedNl, ...auPairHostFamilyNl, ...buySellPropertyNl, ...businessSalePurchaseNl, ...appealCasesNl, ...bookkeepingSolutionsNl, ...cbiBbiNl, ...destinationServicesNl, ...financialManagementNl, ...housingNl, ...lawyersNl, ...manpowerSolutionsNl, ...petRelocationNl, ...partnersNl };
const mergedPa = { ...faqsPa, ...navbarPa, ...businessPermitPa, ...businessVisitPa, ...globalVisitVisasPa, ...workPermitPa, ...eorPayrollPa, ...studyInEuPa, ...asylumPa, ...companyRegistrationPa, ...euCitizensRelocationPa, ...euCitizensParentsPermitPa, ...familyReunificationPa, ...logisticsServicesPa, ...selfEmployedPa, ...auPairHostFamilyPa, ...buySellPropertyPa, ...businessSalePurchasePa, ...appealCasesPa, ...bookkeepingSolutionsPa, ...cbiBbiPa, ...destinationServicesPa, ...financialManagementPa, ...housingPa, ...lawyersPa, ...manpowerSolutionsPa, ...petRelocationPa, ...partnersPa };
const mergedPs = { ...faqsPs, ...navbarPs, ...businessPermitPs, ...businessVisitPs, ...globalVisitVisasPs, ...workPermitPs, ...eorPayrollPs, ...studyInEuPs, ...asylumPs, ...companyRegistrationPs, ...euCitizensRelocationPs, ...euCitizensParentsPermitPs, ...familyReunificationPs, ...logisticsServicesPs, ...selfEmployedPs, ...auPairHostFamilyPs, ...buySellPropertyPs, ...businessSalePurchasePs, ...appealCasesPs, ...bookkeepingSolutionsPs, ...cbiBbiPs, ...destinationServicesPs, ...financialManagementPs, ...housingPs, ...lawyersPs, ...manpowerSolutionsPs, ...petRelocationPs, ...partnersPs };
const mergedTa = { ...faqsTa, ...navbarTa, ...businessPermitTa, ...businessVisitTa, ...globalVisitVisasTa, ...workPermitTa, ...eorPayrollTa, ...studyInEuTa, ...asylumTa, ...companyRegistrationTa, ...euCitizensRelocationTa, ...euCitizensParentsPermitTa, ...familyReunificationTa, ...logisticsServicesTa, ...selfEmployedTa, ...auPairHostFamilyTa, ...buySellPropertyTa, ...businessSalePurchaseTa, ...appealCasesTa, ...bookkeepingSolutionsTa, ...cbiBbiTa, ...destinationServicesTa, ...financialManagementTa, ...housingTa, ...lawyersTa, ...manpowerSolutionsTa, ...petRelocationTa, ...partnersTa };
const mergedTe = { ...faqsTe, ...navbarTe, ...businessPermitTe, ...businessVisitTe, ...globalVisitVisasTe, ...workPermitTe, ...eorPayrollTe, ...studyInEuTe, ...asylumTe, ...companyRegistrationTe, ...euCitizensRelocationTe, ...euCitizensParentsPermitTe, ...familyReunificationTe, ...logisticsServicesTe, ...selfEmployedTe, ...auPairHostFamilyTe, ...buySellPropertyTe, ...businessSalePurchaseTe, ...appealCasesTe, ...bookkeepingSolutionsTe, ...cbiBbiTe, ...destinationServicesTe, ...financialManagementTe, ...housingTe, ...lawyersTe, ...manpowerSolutionsTe, ...petRelocationTe, ...partnersTe };
const mergedUr = { ...faqsUr, ...navbarUr, ...businessPermitUr, ...businessVisitUr, ...globalVisitVisasUr, ...workPermitUr, ...eorPayrollUr, ...studyInEuUr, ...asylumUr, ...companyRegistrationUr, ...euCitizensRelocationUr, ...euCitizensParentsPermitUr, ...familyReunificationUr, ...logisticsServicesUr, ...selfEmployedUr, ...auPairHostFamilyUr, ...buySellPropertyUr, ...businessSalePurchaseUr, ...appealCasesUr, ...bookkeepingSolutionsUr, ...cbiBbiUr, ...destinationServicesUr, ...financialManagementUr, ...housingUr, ...lawyersUr, ...manpowerSolutionsUr, ...petRelocationUr, ...partnersUr };

// Merge Norwegian Bokmål for no alias
const mergedNo = { ...faqsNb, ...navbarNb, ...businessPermitNb, ...businessVisitNb, ...globalVisitVisasNb, ...workPermitNb, ...citizenshipNb, ...eorPayrollNb, ...studyInEuNb, ...asylumNb, ...companyRegistrationNb, ...euCitizensRelocationNb, ...euCitizensParentsPermitNb, ...familyReunificationNb, ...logisticsServicesNb, ...selfEmployedNb, ...auPairHostFamilyNb, ...buySellPropertyNb, ...businessSalePurchaseNb, ...appealCasesNb, ...bookkeepingSolutionsNb, ...cbiBbiNb, ...destinationServicesNb, ...financialManagementNb, ...housingNb, ...lawyersNb, ...manpowerSolutionsNb, ...petRelocationNb, ...partnersNb };
